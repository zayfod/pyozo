...
DEVICE_NAME_SIZE = 17
LINE_NAVIGATION_SPEED_ADDRESS = 0x004025
LINE_NAVIGATION_SPEED_SIZE = 4
LONG_RPC_EXTENSION_DATA_ADDRESS = 0x006000
LONG_RPC_EXTENSION_DATA_SIZE = 128
FW_VERSION_ADDRESS = 0x01002C
FW_VERSION_SIZE = 4
SERIAL_NUMBER_ADDRESS = 0x010050
SERIAL_NUMBER_SIZE = 16
BLUETOOTH_VERSION_ADDRESS = 0x010060
BLUETOOTH_VERSION_SIZE = 4
BLUETOOTH_ADDRESS_ADDRESS = 0x010065
BLUETOOTH_ADDRESS_SIZE = 6
WATCHERS_INFO_ADDRESS = 0x010073
WATCHERS_INFO_SIZE = 2
...
class WatchersInfo(BaseModel):
    """Watchers information."""

    watcher_count: int = Field(FieldType.UINT8, default=0)
    watcher_region_count: int = Field(FieldType.UINT8, default=0)
